...
import 'AnC_Cart.dart';
import 'Cart.dart';
import 'Nose_mask_pro.dart';


class AnC_AddToCart extends StatefulWidget {
  AnC_AddToCart({required this.productName, required this.productId, required this.price, required this. quantity, required this.expiredDate,
  ...
  @override
  State<AnC_AddToCart> createState() => _AnC_AddToCartState();
}

class _AnC_AddToCartState extends State<AnC_AddToCart> {
 ...
 Text(widget.status,style: TextStyle(fontWeight: FontWeight.bold,fontSize:15 ,color: Colors.green),),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      "Date Purchased: ${widget.expiredDate}",
                                      overflow: TextOverflow.ellipsis,
                                      textAlign: TextAlign.left,
                                      style:TextStyle(
                                        color: Colors.black87,
  ...
  Future<void> _addCart() async {
    ...
    if (apiStatusCode == 200) {
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) => AnC_Cart(selectedClientId: widget.selectedClientId, cProductName: '', productId: '',
        price: "${widget.price}", status: '', image: '', quantity: '', cQuantity: '',
