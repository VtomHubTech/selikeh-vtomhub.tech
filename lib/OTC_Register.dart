...
class OTC_Page extends StatefulWidget {
  OTC_Page({
  ...
  @override
  State<OTC_Page> createState() => _OTC_PageState();
}

class _OTC_PageState extends State<OTC_Page> {
    ...
    return Container(
        ...
        child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                'OTC code has been sent to this Number ${widget.strPhoneNumber}',
  ...
  Future<void> _getOTC() async {
    ...
    String RphoneNumber = (prefs.getString('RphoneNumber') ?? '');
    ...
    final response = await http
        ...
        body: jsonEncode(<String, String>{
          ...
          'phoneNumber':widget.strPhoneNumber,
          'auth': '${IP.Auth}',
          'email': emailAddress,
        }))
        .catchError((err) {
