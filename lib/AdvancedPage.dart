...
class _AdvancedPageState extends State<AdvancedPage> {
                                          ...
                                          child: Card(
                                            ...
                                            child: ListTile(
                                              ...
                                              onTap: () async {
                                                ...
                                                // Navigator.push(
                                                //   context,
                                                //   MaterialPageRoute(builder: (context) => Cart(cProductName: items[index]
                                                //       .productName
                                                //       .toString(),
                                                //     productId: '',
                                                //     selectedClientId: "${widget.selectedClientId}", price: '', status: '', image: '', quantity: '', cQuantity: '',)),
                                                // );
                                              },
  ...
  Future<List<advancedModel>> _getadv() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  Future<void> _addCart( String productName, String unitPrice) async {
    ...
    if (apiStatusCode == 200) {
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) => Cart(selectedClientId: "${widget.selectedClientId}", cProductName: '', productId: '', price: unitPrice, status: '', image: '', quantity: '', cQuantity: '', phoneNumber: '',)));
